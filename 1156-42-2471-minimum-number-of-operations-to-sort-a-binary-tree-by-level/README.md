<h2> 1156 42
2471. Minimum Number of Operations to Sort a Binary Tree by Level</h2><hr><div><p>You are given the <code>root</code> of a binary tree with <strong>unique values</strong>.</p>
